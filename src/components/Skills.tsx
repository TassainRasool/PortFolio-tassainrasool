...
import { Code2, Server, Smartphone, GitBranch, Palette, Cog } from "lucide-react";
...
const skills = [
  ...
  },
  {
    ...
    skills: ["Node.js", "Firebase", "REST APIs", "Express", "MongoDB"]
  },
  {
    icon: Smartphone,
  ...
  },
  {
    icon: Cog,
    title: "Other Skills",
    skills: ["Agile/Scrum", "Testing", "Performance Optimization", "Problem Solving"]
  }
];
...
function SkillCard({ skill, index }: { skill: typeof skills[0]; index: number }) {
  ...
  return (
    ...
    >
      <Card className="h-full border-none shadow-lg" style={{ 
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 bg-[#00ADB5]/10 rounded-lg">
              <skill.icon className="text-[#00ADB5]" size={24} />
            </div>
  ...
  return (
    <section className="py-20 bg-[#EEEEEE]" id="skills">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl mb-4 text-[#222831]">What I Bring to the Table</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            A comprehensive skill set built over 3+ years of hands-on experience
          </p>
        </motion.div>
